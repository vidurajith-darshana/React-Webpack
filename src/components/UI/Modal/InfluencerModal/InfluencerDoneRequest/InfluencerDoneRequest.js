...
import classes from './InfluencerDoneRequest.css';

const InfluencerDoneRequest = (props) => (
    <div className={classes.divBody}>
        <center>

            <FontAwesome size="6.5em" name="fa fa-check-circle fa-5x" color="#424242"/>
            <br /><br />
            <h4>Hello!</h4>
            <br />
...
export default InfluencerDoneRequest;