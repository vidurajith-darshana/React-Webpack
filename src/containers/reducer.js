...
import InfluencerSocialAccount
    from "../components/UI/Modal/InfluencerModal/InfluencerSocialAccount/InfluencerSocialAccount";
    ...
    render() {
        ...
        if(this.state.influencerLoginModal){
            showModal= <Modal modalClosed={null} show={true} >
                <InfluencerLogin
                    ...
                    influencerSocialAccountModalShow={this.props.influencerSocialAccountModalHandler}
        ...
        return (
            <Eux>
                ...
                <MainLayout layoutType={this.props.layoutRed}
...
const mapStateToProps = state => {
    ...
    return{
        layoutRed:state.layoutRed.layoutType
    }
...
const mapDispatchToProps = dispatch => {
    ...
    return {
        influencerSocialAccountModalHandler:()=>dispatch(actionCreators.influencerSocialAccountModelHandler())
    }
